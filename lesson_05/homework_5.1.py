...
# Дані про автомобілі
car_data: dict[str, tuple[str, int, float, str, int]] = {
...
# Критерії пошуку (рік >= 2017, об'єм двигуна >= 1.6, ціна <= 36000)
search_criteria = (2017, 1.6, 36000)

# Фільтрація автомобілів за критеріями з тз
filtered_cars = [
    (name, details) for name, details in car_data.items()
    if details[1] >= search_criteria[0]  # Рік випуску >=
    and details[2] >= search_criteria[1]  # Об'єм двигуна >=
